                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateConfig("titleSize", Number.parseInt(e.target.value))}
                        className="w-full"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateConfig("headerSize", Number.parseInt(e.target.value))}
                        className="w-full"
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateConfig("bodySize", Number.parseInt(e.target.value))}
                        className="w-full"
                      />
                    </div>
                  </div>
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      max="300"
                      value={config.width}
                      onChange={(e) => updateConfig("width", Number.parseInt(e.target.value))}
                      className="w-full"
                    />
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateConfig("spacing", Number.parseInt(e.target.value))}
                        className="w-full"
                      />
                    </div>
                  </div>
                    ...
                    {config.showDivider && (
                      <>
                        ...
                        <input
                          ...
                          onChange={(e) => updateConfig("dividerWidth", Number.parseFloat(e.target.value))}
                          className="w-20"
                        />
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => updateConfig("logoSize", Number.parseInt(e.target.value))}
                        className="w-full"
                      />
                    </div>
                    <div>
